...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::dropIfExists('laboratory_reference_value_m');
        Schema::create('laboratory_reference_value_m', function (Blueprint $table) {
            ...
            $table->string('reference_value', 50)->nullable();
