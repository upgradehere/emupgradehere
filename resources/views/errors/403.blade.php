...
.error-page h1:after {
  ...
  background: -webkit-repeating-linear-gradient(-45deg, #64dbc4, #2571a0, #44a4b4, #6bf0d0);
...
<div class="error-page">
  <div>
    ...
    <label>You don't have permission to access this page</label>
    <!--h1(data-h1='500') 500-->
