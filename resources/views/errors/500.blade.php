...
<div class="container">
    <div class="error">
        <img src="{{ asset('/public/assets/images/logo.png') }}" style="width:150px" alt="">
        <h1 style="color:#203981">500</h1>
        <h2 style="color:#A91207">error</h2>
        <p>Oops, something went wrong. Try again to refresh this page or feel free to contact us if the problem persist.</p>
    </div>
