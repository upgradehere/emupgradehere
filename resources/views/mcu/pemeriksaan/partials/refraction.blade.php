        ...
        <div class="card-body">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="existing_images" value="{{ !empty($data_refraction->image_file) ? $data_refraction->image_file : null }}" id="">
                    @if(!empty($data_refraction->image_file))
                        @php
                            $images = collect(json_decode($data_refraction->image_file, true))->sort()->values();
                        @endphp
                        @foreach (json_decode($images, true) as $key => $image_file)
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="{{ asset('uploads/refraction/'.$image_file) }}" alt="" style="width:100%;">
                                </div>
                            </div>
                            <br>
                        @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2 selectDoctorRefraction" name="doctor_id" style="width: 100%;">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" name="action" value="delete" class="btn btn-danger action-delete" {{ empty($data_refraction) ? 'disabled' : '' }}>
