<div class="{{ Auth::user()->id_role == 5 ? 'card disabled-div' : 'card' }}">
    ...
    <form action="/mcu/program-mcu/detail/pemeriksaan/save-spirometry" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="spirometry_id"
            value="{{ !empty($data_spirometry->spirometry_id) ? $data_spirometry->spirometry_id : null }}" id="">
            ...
            <div class="card">
                ...
                <div class="card-body">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            ...
                                            <input type="checkbox" class="form-check-input" value="1"
                                                name="is_import" <?php
                                                if (isset($data_spirometry->is_import)) {
                                                    if ($data_spirometry->is_import == true) {
                                                        echo 'checked';
                                                    } else {
                                                        echo '';
                                                    }
                    ...
                    <input type="hidden" name="existing_images"
                        value="{{ !empty($data_spirometry->image_file) ? $data_spirometry->image_file : null }}"
                        id="">
                    @if (!empty($data_spirometry->image_file))
                        @php
                            $images = collect(json_decode($data_spirometry->image_file, true))
                                ->sort()
                                ->values();
                        @endphp
                        @foreach (json_decode($images, true) as $key => $image_file)
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="{{ asset('uploads/spirometry/' . $image_file) }}" alt=""
                                        style="width:100%;">
                                </div>
                            </div>
                            <br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="mcuCode" name="prediction_value"
                                        value="{{ !empty($data_spirometry->prediction_value) ? $data_spirometry->prediction_value : '' }}"
                                        placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    mL
                            ...
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="mcuCode" name="kvp"
                                        value="{{ !empty($data_spirometry->kvp) ? $data_spirometry->kvp : '' }}"
                                        placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    mL
                            ...
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="mcuCode" name="kvp_percentage"
                                        value="{{ !empty($data_spirometry->kvp_percentage) ? $data_spirometry->kvp_percentage : '' }}"
                                        placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    %
                            ...
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="mcuCode" name="vep"
                                        value="{{ !empty($data_spirometry->vep) ? $data_spirometry->vep : '' }}"
                                        placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    mL
                            ...
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="mcuCode" name="vep_percetage"
                                        value="{{ !empty($data_spirometry->vep_percetage) ? $data_spirometry->vep_percetage : '' }}"
                                        placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    %
                        ...
                        <div class="col-md-6">
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="mcuCode" name="ape"
                                        value="{{ !empty($data_spirometry->ape) ? $data_spirometry->ape : '' }}"
                                        placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    L
                            ...
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="mcuCode" name="ape_total"
                                        value="{{ !empty($data_spirometry->ape_total) ? $data_spirometry->ape_total : '' }}"
                                        placeholder="">
                                </div>
                                <div class="col-sm-2">
                                    L/min
                            ...
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="classification"
                                        value="{{ !empty($data_spirometry->classification) ? $data_spirometry->classification : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="conclusion"
                                        value="{{ !empty($data_spirometry->conclusion) ? $data_spirometry->conclusion : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="is_abnormal" style="width: 100%;">
                                        <option value="0"
                                            {{ isset($data_spirometry->is_abnormal) && $data_spirometry->is_abnormal == 0 ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="1"
                                            {{ isset($data_spirometry->is_abnormal) && $data_spirometry->is_abnormal == 1 ? 'selected' : '' }}>
                                            Abnormal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2 selectDoctorSpirometry" name="doctor_id"
                                        style="width: 100%;">
            ...
            @if (Auth::user()->id_role == 1 || Auth::user()->id_role == 3)
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-danger action-delete"
                        {{ empty($data_spirometry) ? 'disabled' : '' }}>
