                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="hazard_notes"
                                        name="work_hazard_history[hazard_notes]"
                                        value="{{ isset($data_anamnesis->work_hazard_history->hazard_notes) ? $data_anamnesis->work_hazard_history->hazard_notes : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                        </div>
