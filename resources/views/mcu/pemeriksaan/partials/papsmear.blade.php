<div class="{{ Auth::user()->id_role == 5 || (Auth::user()->id_role == 3 && Auth::user()->examination_type == 30) ? 'card disabled-div' : 'card' }}">
    ...
    <form action="/mcu/program-mcu/detail/pemeriksaan/save-papsmear" method="POST">
        @csrf
        <input type="hidden" name="papsmear_id"
            value="{{ !empty($data_papsmear->papsmear_id) ? $data_papsmear->papsmear_id : null }}" id="">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mcuCode" name="conclusion"
                                        value="{{ !empty($data_papsmear->conclusion) ? $data_papsmear->conclusion : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mcuCode" name="classification"
                                        value="{{ !empty($data_papsmear->classification) ? $data_papsmear->classification : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mcuCode" name="speciment"
                                        value="{{ !empty($data_papsmear->speciment) ? $data_papsmear->speciment : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mcuCode"
                                        ...
                                        value="{{ !empty($data_papsmear->clinical_description) ? $data_papsmear->clinical_description : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mcuCode" name="general_category"
                                        value="{{ !empty($data_papsmear->general_category) ? $data_papsmear->general_category : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="mcuCode" name="recommendations"
                                        value="{{ !empty($data_papsmear->recommendations) ? $data_papsmear->recommendations : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="is_abnormal" style="width: 100%;">
                                        <option value="0"
                                            {{ isset($data_papsmear->is_abnormal) && $data_papsmear->is_abnormal == 0 ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="1"
                                            {{ isset($data_papsmear->is_abnormal) && $data_papsmear->is_abnormal == 1 ? 'selected' : '' }}>
                                            Abnormal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2 selectDoctorPapsmear" name="doctor_id"
                                        style="width: 100%;">
