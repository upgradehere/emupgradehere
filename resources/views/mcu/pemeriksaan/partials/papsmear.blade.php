                            ...
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="is_abnormal" style="width: 100%;">
                                        <option value="0" {{ isset($data_papsmear->is_abnormal) && $data_papsmear->is_abnormal == 0 ? 'selected' : '' }}>Normal</option>
                                        <option value="1" {{ isset($data_papsmear->is_abnormal) && $data_papsmear->is_abnormal == 1 ? 'selected' : '' }}>Abnormal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
