        ...
        <div class="card-body">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="existing_images" value="{{ !empty($data_usg->image_file) ? $data_usg->image_file : null }}" id="">
                    @if(!empty($data_usg->image_file))
                        @foreach (json_decode($data_usg->image_file, true) as $key => $image_file)
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="{{ asset('uploads/usg/'.$image_file) }}" alt="" style="width:100%;">
                                </div>
                            </div>
                            <br>
                        @endforeach
