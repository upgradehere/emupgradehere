<div class="{{ Auth::user()->id_role == 5 ? 'card disabled-div' : 'card' }}">
    ...
    <form action="/mcu/program-mcu/detail/pemeriksaan/save-usg" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="usg_id" value="{{ !empty($data_usg->usg_id) ? $data_usg->usg_id : null }}"
            id="">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="existing_images"
                        value="{{ !empty($data_usg->image_file) ? $data_usg->image_file : null }}" id="">
                    @if (!empty($data_usg->image_file))
                        @foreach (json_decode($data_usg->image_file, true) as $key => $image_file)
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="{{ asset('uploads/usg/' . $image_file) }}" alt=""
                                        style="width:100%;">
                                </div>
                            </div>
                            <br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="liver"
                                        value="{{ !empty($data_usg->liver) ? $data_usg->liver : '' }}" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                <label class="col-sm-4 col-form-label">Kantong Empedu</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="gallbladder"
                                        value="{{ !empty($data_usg->gallbladder) ? $data_usg->gallbladder : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="pancreas"
                                        value="{{ !empty($data_usg->pancreas) ? $data_usg->pancreas : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="lien"
                                        value="{{ !empty($data_usg->lien) ? $data_usg->lien : '' }}" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                <label class="col-sm-4 col-form-label">Ginjal</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="kidney"
                                        value="{{ !empty($data_usg->kidney) ? $data_usg->kidney : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="bladder"
                                        value="{{ !empty($data_usg->bladder) ? $data_usg->bladder : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="prostat"
                                        value="{{ !empty($data_usg->prostat) ? $data_usg->prostat : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="classification"
                                        value="{{ !empty($data_usg->classification) ? $data_usg->classification : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="mcuCode" name="suggestion"
                                        value="{{ !empty($data_usg->suggestion) ? $data_usg->suggestion : '' }}"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="is_abnormal" style="width: 100%;">
                                        <option value="0"
                                            {{ isset($data_usg->is_abnormal) && $data_usg->is_abnormal == 0 ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="1"
                                            {{ isset($data_usg->is_abnormal) && $data_usg->is_abnormal == 1 ? 'selected' : '' }}>
                                            Abnormal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row align-items-center mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2 selectDoctorUsg" name="doctor_id"
                                        style="width: 100%;">
